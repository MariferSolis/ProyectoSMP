...
namespace ProyectoSMP.Models
{
    ...
    public partial class SMPEntities : DbContext
    {
        ...
        public virtual ObjectResult<string> ExisteCorreo(string correo)
        {
            var correoParameter = correo != null ?
                new ObjectParameter("Correo", correo) :
                new ObjectParameter("Correo", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("ExisteCorreo", correoParameter);
        }
